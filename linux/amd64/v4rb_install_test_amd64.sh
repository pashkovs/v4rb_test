...
DEB_FILE="v4rb_x64_${MAJOR_VERSION}_lin.deb"
...
cp "$V4RB_INSTALL_DIR/ValentinaPlugin/ValentinaPlugin.xojo_plugin/Valentina/Build Resources/Linux x86-64/v4rb_x64_release.so" 'linux/amd64/TestProjectConsole/TestProjectConsole Libs'

# Run the V4RB application and capture the output
OUTPUT=$(linux/amd64/TestProjectConsole/TestProjectConsole)
