...
powershell -Command "Start-Process -FilePath '%EXE_PATH%' -ArgumentList '/SILENT', '/SUPPRESSMSGBOXES', '/NORESTART', '/LOG=%LOG_PATH%', 'LOADINF=%INF_PATH%' -NoNewWindow -PassThru | Wait-Process -Timeout 30"
